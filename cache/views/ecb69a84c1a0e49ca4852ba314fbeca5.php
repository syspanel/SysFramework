...
<head>
  ...
  <link rel="icon" href="<?php echo htmlspecialchars(asset('img/favicon.ico'), ENT_QUOTES, "UTF-8"); ?>" type="image/x-icon">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
  <div class="container">
    <a class="navbar-brand d-flex align-items-center" href="/">
      <img src="<?php echo htmlspecialchars(asset('/assets/bootstrap5/img/s.png'), ENT_QUOTES, "UTF-8"); ?>" width="40" height="32" class="me-2">
