...
position: fixed;
    ...
    <?php echo $this->stack('styles'); ?> <!-- Allows you to push additional CSS styles from child views -->
</head>
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="/systables">SysTables</a></li>
...
<br>
    ...
    <footer class="footer bg-dark text-white text-center py-3 navbar-fixed-bottom">
        <div class="container mt-3">
            <p class="mb-0">&copy; <?php echo htmlspecialchars(date('Y'), ENT_QUOTES, "UTF-8"); ?> SysFramework Versão 1.0 
    ...
    <?php echo $this->stack('scripts'); ?> <!-- Allows you to push additional JavaScript from child views -->
</body>
</html>
